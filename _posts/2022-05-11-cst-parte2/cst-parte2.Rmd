...
La importancia de la **Tabla 5** radica en, por un lado, conocer la
dimensión y las relaciones sectoriales de los productores
característicos del turismo, y por otro, en función de la apertura
lograda en las actividades características impactar en la calidad de la
medición del valor agregado generado por el consumo del visitante.
