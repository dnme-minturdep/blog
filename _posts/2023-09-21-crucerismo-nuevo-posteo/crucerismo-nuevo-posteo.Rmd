...
La estructura de este nuevo informe es muy similar a la que se puede observar en el de la temporada 19/20, destacándose, en primera instancia, dos ejes grandes temáticos:

- **Volumen y perfil de los cruceristas:** 

Este informe nos permite monitoriear la evolución del crucerismo en nuestro país. De esta manera, se aprecia cómo **en la última temporada la actividad volvió a mostrar valores pre-pandémicos**, superando a la temporada 2019/2020 (y con valores levemente inferiores a los de la temporada 2018/19):
...
En esta sección del informe se observa cómo, en el Puerto de Ushuaia,**en la última temporada se registró el valor más elevado de cruceristas de las últimas siete temporadas**. También se aprecia que los cruceros que realizaron viajes "Antárticos" realizaron el mayor aporte al volumen total de cruceristas:
...
Dentro de esta sección, **también se podrán apreciar datos vinculados a la evolución de los cruceros registrados y la cantidad de recaladas por temporada**.

El informe se encuentra disponible en https://biblioteca.yvera.tur.ar/, **y se puede acceder al mismo a través del siguiente link (poner link)**

**La información también se encuentra presenta en el [Tablero Interactivo de Crucerismo Marítimo en la Argentina](https://tableros.yvera.tur.ar/crucerismo/).**

Además, se creo un nuevo dataset de **[Crucerismo Marítimo en la Argentina](Poner link)**, en el cual se pueden descargar recursos en formato _csv_ que **refieren al volumen de cruceristas por temporada, mes, puerto, edad, género, condición de residencia, país de residencia y crucero.** 
