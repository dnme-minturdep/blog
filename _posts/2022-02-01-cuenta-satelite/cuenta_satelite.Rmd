...
En una sección específica del [Sistema de Información Turística de la Argentina (SINTA)](https://www.yvera.tur.ar/estadistica/informe/cuenta-satelite-de-turismo){target=”_blank”} se puede acceder al informe técnico con información de los años 2004 y 2016-2019, el documento metodológico y los principales cuadros estadísticos.
...
[^6]: **Fuente:** https://www.unwto.org/statistic-data-economic-contribution-of-tourism-and-beyond{target=”_blank”}
...
grafico_consumo_interior <- consumo_interior %>% 
  ...
  geom_col(fill=dnmye::dnmye_col(1)[[1]]) +
...
grafico_pibdt_paises <- pibdt_paises %>% 
 ...
 geom_text(aes(x = reorder(pais,pbidt_ultimo_ano_disponible), y = pbidt_ultimo_ano_disponible, label = paste0(format(pbidt_ultimo_ano_disponible,decimal.mark=",",big.mark=".")),color=turismo),
  ...
  scale_fill_manual(values = c("si"=dnmye_col(1)[[1]],
                               "no" = dnmye_col(5)[[1]] ))+
  scale_color_manual(values = c("si"=dnmye_col(1)[[1]],
                               "no" = dnmye_col(5)[[1]] ))+
  coord_flip(clip="off")+
...
empleo %>% 
  ...
  tab_header(title=md("**Puestos de trabajo en las industrias características del turismo**"),
             subtitle=md("*Total y participación sobre economía total. Años 2004 y 2016-2019*")) %>% 
  tab_source_note(source_note = md("**Fuente:** Ministerio de Turismo y Deportes. Instituto Nacional de Estadística y Censos")) 
```
...
[**Publicación**](https://www.yvera.tur.ar/estadistica/informe/cuenta-satelite-de-turismo){target=”_blank”}
