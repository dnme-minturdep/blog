...
A continuación, mostraremos algunos ejemplos para obtener una visualización a partir de la base de microdatos provista por la DNMyE. Para conocer las características principales de la **Encuesta de Viajes y Turismo de los Hogares** se puede acceder a la [ficha técnica](http://datos.yvera.gob.ar/dataset/b5819e9b-5edf-4aad-bd39-a81158a2b3f3/resource/1b5d26f1-0ab9-4908-a44f-9ac5bd685f1b/download/2021.01.05_evyth-data.pdf), también ubicada en el portal.

Los ejercicios propuestos debajo fueron procesados mediante el [lenguaje de programación R](https://www.r-project.org/). Entre las principales razones por las cuales se optó por este lenguaje se encuentran la de ser software libre y de código abierto, su potencia para el procesamiento sistemático de datos y capacidad para desarrollar visualizaciónes a medida. [^2]
Al mismo tiempo, los resultaros se obtuvieron a través del procesamiento de la base de microdatos disponible en el [Portal de Datos Abiertos](http://datos.yvera.gob.ar/) de la DNMyE-MINTURyDEP, a través del [siguiente link](http://datos.yvera.gob.ar/dataset/b5819e9b-5edf-4aad-bd39-a81158a2b3f3/resource/8c663c32-fee2-4a57-a918-7ab0f3819624/download/evyth_microdatos.txt) y el [diccionario de registro](http://datos.yvera.gob.ar/dataset/b5819e9b-5edf-4aad-bd39-a81158a2b3f3/resource/20e2c018-a2ee-4d97-9c67-a4303f669255/download/evyth_diccionario_registro.txt), de donde podemos obtener el conjunto de etiquetas para cada una de las variables y sus respectivas categorías. 
...
El primer paso para obtener el ranking fue elegir los años de los cuales se cuenta información y un trimestre particular (el último disponible) para poder hacer una comparación sin tener en cuenta el efecto estacionalidad. Luego se realizó un conteo de personas en función de la provincia de destino del viaje. A partir de este procesamiento se utilizó el [paquete de R `ggnum`](https://github.com/davidsjoberg/ggbump), con el que se pueden crear gráficos de clasificación (_bump chart_), los cuales permiten mostrar la posición relativa de ciertos elementos a lo largo del tiempo. Con ello se logran tres ejes, con los años analizados y la posición de asume cada una de las provincias a lo largo del tiempo.


## Aglomerado de orígen de los viajeros que ingresaron a la Provincia de Salta

En el primer ejemplo, se eligó a la provincia de Salta como destino y se realizó un conteo de la cantidad de personas que visitaron dicha provincia, por un lado, en función del aglomerado de orígen de dichos visitantes. De esta forma, en el gráfico se podrán visualizar dos ejes principales: a la derecha, la provincia de destino con el conteo de la cantidad de personas que recibió. A la izquiera, el aglomerado de orígen de las personas que viajaron al destino en cuestión, con el peso relativo de cada uno respecto al total.
...
El resultado de esta visualización permite ver quiénes son los principales aglomerados que contribuyen al turismo de una provincia. En particular, vemos como en la Provincia de Salta, para el 3er trimestre de 2021, poco más del 70% de sus visitantes provienen del aglomerado Salta. Muy lejos atrás se encuentra el aglomerado Gran Tucumán - Tafí Viejo, representando apenas un 7% del total de viajeros.



## Aglomerado de orígen de los viajeros que ingresaron a la ciudad San Carlos de Bariloche

En el siguiente ejemplo se muestra cómo, además de una provincia, se puede elegir como destino a una localidad. En este caso, se tomó a la ciudad San Carlos de Bariloche para enteder cuáles son los principales aglomerados de orígen de los visitantes que deciden viajar a la ciudad.
