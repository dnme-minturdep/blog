...
A partir de esta publicación se encontrará disponible en el [portal de datos abiertos](http://datos.yvera.gob.ar/) la base de **microdatos** correspondiente a los años 2019, 2020 y hasta el primer trimestre de 2021 inclusive, y su respectivo **diseño de registro**, a través del cual se podrá identificar el nombre de las variables (columnas), las categorías de respuesta y sus respectivas etiquetas.
