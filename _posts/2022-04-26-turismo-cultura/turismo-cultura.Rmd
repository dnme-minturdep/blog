...
### PRINCIPALES REGIONES ELEGIDAS PARA REALIZAR TURISMO.
...
destinos_cultura <- 
  ...
  labs(title = str_wrap("PRINCIPALES REGIONES ELEGIDAS PARA REALIZAR TURISMO DE CULTURA.", width = 30),
       subtitle = "AÑO 2019.") +     
  theme_void() + 
...
destinos_totales <- ggplot() + 
  ...
  comunicacion::scale_fill_dnmye(palette = "c10_todos")+
  comunicacion::scale_color_dnmye(palette = "c10_todos")+
  labs(title = str_wrap("PRINCIPALES REGIONES ELEGIDAS PARA REALIZAR TURISMO.", width = 30),
       subtitle = "AÑO 2019.") +
  theme_void() + 
  theme(legend.position="none",
        title = element_text(size = 10)) +
