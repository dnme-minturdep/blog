...
description: |
  La Dirección Nacional de Mercados y Estadística (DNMYE) gracias a la colaboración de la [Administración Nacional de Aviación Civil (ANAC) dependiente del Ministerio de Transporte de la Nación](https://www.argentina.gob.ar/anac) pone a disposición el [Tablero de Conectividad Aérea](%22https://tableros.yvera.tur.ar/conectividad/%22)
date: 2022-10-27
output:
...
Los datos utilizados provienen de la ANAC y son procesados por la DNMYE para reducir el universo de análisis a aquellos movimientos aéreos relevantes para la actividad turística. Es por eso que del total de movimientos registrados por la ANAC sólo se presenta la información correspondiente a movimientos de las principales líneas aerocomerciales, excluyendo los movimientos de vuelos charter, trabajos aéreos, instrucción, vuelos oficiales y vuelos privados. 
