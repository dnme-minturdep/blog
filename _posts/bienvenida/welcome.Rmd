...
-   El proyecto de [*Armonización de las Estadísticas Provinciales de Turismo*](https://armonizacion.yvera.tur.ar/) que tiene comoobjetivo contribuir al fortalecimiento de los sistemas de estadística provinciales para generar información robusta y confiable de la actividad turística de nuestro país.
...
El proyecto contempla una serie de actividades que incluyen: diagnóstico de funcionamiento y capacidades de las oficinas a cargo de las estadísticas de turismo en el país; el desarrollo de materiales con propuestas teóricas y metodológicas para el trabajo estadístico de turismo a nivel subnacional; capacitaciones teóricas y prácticas a referentes técnicos de estadísticas; la creación de un foro de intercambio permamenente entre referntes técnicos de los distintos niveles de gobierno; y la generación de una herramienta de gestión de datos federal.
...
Les damos la bienvenida a *la Bitácora*, con la expectativa de que este espacio sea de utilidad para acercar el trabajo que se está llevando adelante desde el Ministerio de Turismo y Deportes de la Nación.
