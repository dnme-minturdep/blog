---
title: "{Herramientas} para el procesamiento de datos y {Comunicación} de la DNMyE"
description: |
  Presentación de los paquetes `{herramientas}` y `{comunicación}`, desarrollados por la Dirección Nacional de Mercados y Estadística del Ministerio de Turismo y Deportes de la Nación
output:
...
knitr::include_graphics("https://github.com/dnme-minturdep/comunicacion/blob/master/man/figures/logo_comunicacion.png?raw=true")
```
