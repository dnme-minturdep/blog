...
A partir de la colaboración con la [Administración Nacional de Aviación Civil (ANAC) dependiente del Ministerio de Transporte de la Nación](https://www.argentina.gob.ar/anac), la Dirección Nacional de Mercados y Estadística (DNMYE) pone a disposición dos nuevos recursos, un documento de trabajo y un reporte, para el análisis del mercado aerocomercial y el flujo de pasajeros en el país. Los mismos, en conjunto al [Tablero de Conectividad Aérea](%22https://tableros.yvera.tur.ar/conectividad/%22) del [Sistema de Información Turística de la Argentina (SINTA)](https://www.yvera.tur.ar/sinta/), suponen una nueva fuente de datos para el estudio de una dimensión clave de la actividad turística nacional.
...
El ["Documento de Trabajo N°11: Conectividad Aérea. Diagnóstico turístico del mercado aerocomercial de Argentina."](https://tableros.yvera.tur.ar/recursos/biblioteca/conectividad_aerea.pdf), disponible en la [Biblioteca](https://biblioteca.yvera.tur.ar/) del [Sistema de Información Turística de Argentina (SINTA)](https://www.yvera.tur.ar/sinta/) realiza un análisis descriptivo de información estadística vinculada al mercado de cabotaje y al mercado internacional aerocomercial en lo referido a vuelos, pasajeros, asientos, rutas aéreas y aerolíneas, entre los años 2017 y 2023.
...
En lo que respecta al mercado comercial, no solo los indicadores de desempeño han mejorado, sino que también aquellos vinculados a la conectividad aérea. Por un lado, en la actualidad, existen más rutas aéreas y más conexiones federales que hace 4 años atras y, por el otro, el mercado aerocomercial se ha ido desconcentrado con la consolidación de nuevos actores.
...
En lo referido al mercado internacional aerocomercial, la pandemia significó un quiebre abrupto en la actividad económica. En línea con lo que ocurrido alrededor del mundo[^1], la recuperación del mercado aéreo fue mucho más lenta que en el de cabotaje y varios de los indicadores se encuentran aún por debajo de los existentes a principios del 2020. Sin embargo, se espera que en los próximos meses del 2023 se reactiven viejos corredores aéreos detenidos durante la crisis mundial, aumenten su frecuencia servicios existentes y se sumen nuevas conexiones y compañías al mercado.
...
De manera complementaria al Documento de Trabajo, la Dirección Nacional de Mercados y Estadística elabora mensualmente un informe sintético que reúne los datos actualizados del flujo aerocomercial turístico correspondientes al mes previo, nutriéndose de las mismas estadísticas de vuelos antes mencionadas en este blog. En esta oportunidad, se publica el último Informe Mensual de Conectividad Aérea, correspondiente al mes de Mayo.
