...
La segunda pestaña permite visualizar las visitas filtrando por **año, mes, categoría de Área Protegida (Nacionales y Provinciales[^1]), regiones turísticas y provincias donde se ubican las distintas áreas, así como por área protegida**. Asimsmo, se puede seleccionar distintas opciones de visualización de la información en forma de tabla de manera tal que los usuarios puedan descargar sus propios procesamientos.
