...
description: |
  Desarrollo de un visor de información gegoráfica sobre el turismo junto a oportunidades de negocio geolocalizadas para la toma de decisiones de inversión.
output:
...
Como parte de esta propuesta, desde la **Dirección Nacional de Mercados y Estadística (DNMyE)**, publicamos un visor de información geográfica que implicó un trabajo de georeferenciación de información y el desarrollo de una herramienta interactiva para facilitar la experiencia de descubrimiento de esa infomración. El mapa forma parte de la Plataforma de Inversiones Turísticas y fue desarrollado con el objetivo de facilitar el análisis y la toma de decisiones sobre las oportunidades de negocios en el contexto de sus jurisdicciones.
...
3.  Una vez elegido un distrito se puede marcar una caja que permite visualizar **Obras de Infraestructura Turística** en curso e (diferenciando si las mismas ya se encuentran financiadas o proyectadas).
...
4.  La herramienta presenta luego tres tipos de **capas de información adicional** que pueden ser activadas:
    ...
    -   ***CAPAS GEOGRAFCIAS***: permite visualizar polígonos de áreas protegidas y la propuesta territorial del programa [La Ruta Natural](https://larutanatural.gob.ar/).
