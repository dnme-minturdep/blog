...
#aglos <- sf::st_read('aglomerados_eph.json')
...
ggplot(tabla_graf) +
  ...
  labs(
    title="20 principales destinos turísticos según cantidad de turistas recibidos",
...
ggsave("salidas/ranking_localidades.png",width = 25, height = 10, dpi = 300)
```
