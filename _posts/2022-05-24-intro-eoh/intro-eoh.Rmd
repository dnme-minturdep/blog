...
description: |
 Caracteristicas principales del relevamiento y pontenciales usos de la información generada.
output:
...
La EOH es un relevamiento coordinado entre el *Ministerio de Turismo y Deportes de la Nación* y el *Instituto Nacional de Estadísticas y Censos (INDEC)* que se realiza de manera continua desde el año 2004 hasta la actualidad.
